...
<head>
    ...
    <link href="{{asset('adminassets/plugins/custom/prismjs/prismjs.bundle.rtl.css')}}" rel="stylesheet"
        type="text/css" />
    <!--end::Page Vendor Stylesheets-->
    <link href="{{asset('adminassets/plugins/custom/fullcalendar/fullcalendar.bundle.rtl.css')}}" rel="stylesheet"
        type="text/css" />
                                            ...
                                            <div class="menu-sub menu-sub-dropdown w-175px py-4">
                                                ...
                                                <div class="menu-item px-3">
                                                    <a href="../../demo1/dist/account/settings.html"
                                                        ...
                                                        <span class="symbol symbol-20px me-4">
                                                            <img class="rounded-1"
                                                                src="{{asset('adminassets/media/flags/france.svg')}}" alt="" />
                                                        </span>French</a>
                                                </div>
                                                <!--end::Menu item-->
                                            </div>
                        ...
                        <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
                            ...
                            <div data-kt-swapper="true" data-kt-swapper-mode="prepend"
                                ...
                                <h1 class="d-flex text-dark fw-bolder fs-3 align-items-center my-1">@yield('title')
                                    ...
                                    <!--end::Separator-->
                                    <!--begin::Description-->
                                    <span class="text-muted fs-7 fw-bold mt-2">@yield('small-title')</span>
                                    <!--end::Description-->
                                </h1>
                                <!--end::Title-->
                            </div>
