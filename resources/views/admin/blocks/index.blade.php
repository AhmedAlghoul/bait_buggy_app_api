        ...
        <div class="table-responsive">
            <table id="kt_datatable_zero_configuration" class="table table-row-bordered gy-5 table-bordered">
                ...
                <tbody>
                    ...
                    <tr>
                        <td>{{$block->id}}</td>
                        <td>{{$block->blockers->user_name}}</td>
                        <td>{{ $block->blockedUsers->user_name }}</td>


                        <td>
                            <a href="{{route('block.edit',$block->id)}}" class="btn btn-info">
                                <i class="fas fa-edit"></i>
                            </a>

                            <a href="#" class="btn btn-danger" onclick="confirmDestroy({{$block->id}})">
