...
<form class="form" style="background-color: white; border: 1px solid #e4e7f0; padding: 20px;" role="form" method="POST"
    ...
    <div class="card-body">
        ...
        <div class="fv-row mb-7 fv-plugins-icon-container">
            <!--begin::Label-->
            <label class="required fw-bold fs-6 mb-2">Shop Name</label>
            <!--end::Label-->
            <!--begin::Input-->
        ...
        <div class="fv-row mb-7">
            <!--begin::Label-->
            <label class="d-block fw-bold fs-6 mb-5">Logo photo</label>
            <!--end::Label-->
            <!--begin::Image input-->
            <div class="image-input image-input-outline" data-kt-image-input="true"
                ...
                <label class="btn btn-icon btn-circle btn-active-color-primary w-25px h-25px bg-body shadow"
                    ...
                    <!--begin::Inputs-->
                    <input type="file" name="logo_photo_url">
        ...
        <div class="fv-row mb-7">
            <!--begin::Label-->
            <label class="d-block fw-bold fs-6 mb-5">Cover photo</label>
            <!--end::Label-->
            <!--begin::Image input-->
            <div class="image-input image-input-outline" data-kt-image-input="true"
                style="background-image: url('assets/media/svg/avatars/blank.svg')">
                ...
                <label class="btn btn-icon btn-circle btn-active-color-primary w-25px h-25px bg-body shadow"
                    ...
                    <i class="bi bi-pencil-fill fs-7"></i>
                    <!--begin::Inputs-->
                    <input type="file" name="cover_photo_url">
                    <input type="hidden" name="photo_remove">
                    <!--end::Inputs-->
                </label>
                <!--end::Label-->
